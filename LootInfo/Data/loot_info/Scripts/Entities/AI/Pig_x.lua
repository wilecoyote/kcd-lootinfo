...
-- JCDLootInfo -------------------------
function Pig_x:OnSave(table)
  table.bSearched = self.bSearched;
end

function Pig_x:OnLoad(table)
  self.bSearched = table.bSearched;
end

function Pig_x:bIsInventoryEmpty()
...
function Pig_x:OnReset(bFromInit, bIsReload)
...
function Pig_x:SetFree(rescuer)
...
function Pig_x:GetUsableMessage()
